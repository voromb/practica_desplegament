...
### 1️ Clonar repositori
```bash
git clone https://github.com/voromb/practica_desplegament.git
```
![1](./img/1.png)

### 2️ Inicialitzar Git Flow
```bash
git flow init
```
![2](./img/2.png)

### 3️ Crear estructura del projecte
![3](./img/3.png)

### 4️ Primer commit assegurant estructura
```bash
git add .
...
### 5️ Tancar feature estructura_inicial
```bash
git flow feature finish estructura_inicial
```
![5](./img/5.png)

### 6️ Crear feature contingutHTML
```bash
git flow feature start contingutHTML
```
![6](./img/6.png)

### 7️ Commit de contingutHTML
```bash
git commit -m "feat(contingutHTML): afegir exemple d'interacció HTML"
```
![7](./img/7.png)

### 8️ Finalitzar feature contingutHTML
```bash
git flow feature finish contingutHTML
```
![8](./img/8.png)

### 9️ Crear feature atributsHTML
```bash
git flow feature start atributsHTML
```
![9](./img/9.png)

### 10 Commit atributsHTML 
![10](./img/10.png)

### 11 Finalitzar feature atributsHTML
![11](./img/11.png)

### 12 Crear feature estilsCSS
```bash
...
### 14 Finalitzar feature estilsCSS
![14](./img/14.png)

### 15 Iniciar release v1.0
```bash
git flow release start v1.0
```
![15](./img/15.png)

### 16 Finalitzar release amb tag
```bash
...
### 19 Finalitzar hotfix
```bash
git flow hotfix finish milloresV_1_0
```
![19](./img/19.png)

### 20 Push final de branques i tags
```bash
